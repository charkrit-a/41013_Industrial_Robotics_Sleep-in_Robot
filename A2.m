...
%%
    ...
    % define environment
    stationaryCollideables = EnvironmentA2();

    % floating object
    movingCollideables = Entity("CerealBox_Purple.ply", transl(0,0,0.1));
    
    % plot robots
    r1 = Robot(LinearUR10e(transl(-0.3,0,0)), transl(0,0,0.08)*troty(-pi/2), [0 0 0 0 0 0 0]);%, stationaryCollideables);
    r2 = Robot(UR3e(transl(0.5,0.2,0)*trotz(pi/2), true, 'gripper_2fg7_base'), transl(0,0,0.05), [0 -pi/2 pi/2 -pi/2 -pi/2 0]);%, stationaryCollideables);
            ...
            case 2 % breakfast
                ...
                switch brekky
                    ...
                    case 3 %UR10e moves to predetermined joint positions before placing cereal box on the table
                        ...
                        r1Done = r1.Animate(movingCollideables.mesh_h, cerealGreen);
                        if r1Done
                            brekky = brekky+1;
                        end
                    ...
                    case 5  %UR10e moves to predetermined joint positions before picking up milk and UR3 moves to predetermined joint positions before picking up cereal box   
                        ...
                        r1Done = r1.Animate(movingCollideables.mesh_h);
                        r2Done = r2.Animate(movingCollideables.mesh_h);
                        if r1Done && r2Done
                            brekky = brekky+1;
                        end
                    ...
                    case 7 %Ur10e moves to place the milk carton on the table and UR3 moves cereal box to pour into the bowl
                        ...
                        r1Done = r1.Animate(movingCollideables.mesh_h, milk);
                        r2Done = r2.Animate(movingCollideables.mesh_h, cerealGreen, troty(-pi/2)*trotx(-pi/2));
                        if r1Done && r2Done
                            brekky = brekky+1;
                        end 
                    ...
                    case 12 %Ur10e moves to predetermined joint positions before picking up cereal box and UR3 moves cereal box to pour into the bowl
                        ...
                        r1Done = r1.Animate(movingCollideables.mesh_h);
                        r2Done = r2.Animate(movingCollideables.mesh_h, milk,trotx(-pi/2));
                        if r1Done && r2Done
                            brekky = brekky+1;
                        end
